...
function ModalAddCategorie({ close }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        fetchData("http://localhost:4000/api/v1/categories", "POST", formData);
    };
            ...
            <div id="crud-modal" tabIndex="-1" aria-hidden="true" className=" bg-black bg-opacity-25 flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%)] max-h-full">
                <div className="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div className="relative bg-white rounded-lg shadow ">
                        {/*Modal header*/}
                        <div className="flex items-center justify-between p-4 md:p-2 border-b rounded-t ">
                        ...
                        {/*Modal body*/}
                        <form className="p-4 md:p-2" onSubmit={handleSubmit}>
